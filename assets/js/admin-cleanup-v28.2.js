...
(function(){
  ...
  const NAV=[
    ['','Resumen','admin.html'],
    ['GESTIÓN','Socios','socios-admin.html'],['','Categorías y cuotas','categorias-cuotas-admin.html'],['','Campañas de abonados','campanas-admin.html'],['','ON TOUR','viajes-admin.html'],['','Material y solicitudes','tienda-admin.html'],
    ['CONTENIDO WEB','Noticias','noticias-admin.html'],['','Galería y multimedia','multimedia-admin.html'],['','Próximos partidos','partidos-admin.html'],['','Historia de la Peña','historia-admin.html'],
    ['ADMINISTRACIÓN','Plantillas y autorizaciones','documentos-admin.html'],['','Comunicaciones','comunicaciones-admin.html'],['','Usuarios y permisos','usuarios-admin.html'],['','Configuración','configuracion-admin.html'],['','Copias de seguridad','backups-admin.html'],
  ...
  function rebuildSidebar(){
    ...
    const version=document.querySelector('.admin-pro-brand span');if(version)version.textContent='Panel de administración';
  }
  function addBack(){
