...
async function confirmImport(){
 ...
 try{
  ...
  for(const item of previewAnalysis.valid){
   ...
   else if(!member)newIssues.push({campana_id:current.id,tipo:'socio_no_localizado',gravedad:'alta',descripcion:`No se pudo vincular ${item.name||item.dni}.`});
